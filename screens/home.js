...
export default class HomeScreen extends Component {
  ...
  getMovie = () => {
    const url = "http://ebce95e81cd1.ngrok.io/get-movie";
    axios
      .get(url)
      .then(response => {
  ...
  likedMovie = () => {
    const url = "http://ebce95e81cd1.ngrok.io/liked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  unlikedMovie = () => {
    const url = "http://ebce95e81cd1.ngrok.io/unliked-movie";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
  ...
  notWatched = () => {
    const url = "http://ebce95e81cd1.ngrok.io/did-not-watch";
    axios
      .post(url)
      .then(response => {
        this.getMovie();
